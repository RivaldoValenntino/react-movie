...
const Series = () => {
    ...
    return (
        ...
        <div className="container">
          ...
          <section className="trending-section grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 px-10">
            {tvSeries.map((movie) => (
             ...
             <div className="card-desc absolute inset-0 flex flex-col justify-center items-center text-gray opacity-0 hover:opacity-100 transition-opacity duration-300 backdrop-blur-lg p-4">
                  <h3 className="text-slate-50 lg:text-xl md:text-sm text-center font-bold text-shadow-md" style={{ textShadow: '3px 3px 5px #000000' }}>{movie.name}</h3>
