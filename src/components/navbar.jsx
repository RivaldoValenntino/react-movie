...
const Navbar = (props) => {
  ...
  const navbarClass = scrolling
    ? "bg-[#101820] fixed w-full top-0 p-4 z-[999]"
    : "lg:bg-transparent bg-[#101820] fixed w-full top-0 p-4 z-[999]";
    ...
    <header>
      <nav className={navbarClass}>
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div
            className="text-white text-2xl font-bold lg:-ml-20"
          ...
          <div
            className="hidden md:flex space-x-4 justify-center"
            style={{ fontFamily: "Poppins" }}
          >
            <Link to={"/"}>
              <button
                className={`text-white px-5 py-2 links ${
                  isHomePage ? "bg-blue-500 rounded-lg" : ""
            ...
            <Link
              to={"/all-movies"}
              className={`px-5 py-2 text-white links ${
                isAllPages ? "bg-blue-500 rounded-lg" : "hover:text-gray-300"
              } focus:outline-none`}
            >
              All Movies
            </Link>
            <Link
              to={"/list-tv"}
              className={`px-5 py-2 text-white links ${
                isTvPage ? "bg-blue-500 rounded-lg" : "hover:text-gray-300"
              } focus:outline-none`}
            >
              Tv Series
            </Link>
            <Link
              to={"/list-movies"}
              className={`px-5 py-2 text-white links ${
                isListPage ? "bg-blue-500 rounded-lg" : "hover:text-gray-300"
              } focus:outline-none`}
            >
              Movies
            </Link>
        ...
        {isOpen && (
          <div
            className="md:hidden mt-2 bg-transparent"
            style={{ fontFamily: "Poppins" }}
          >
