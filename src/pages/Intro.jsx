        ...
        <>
            ...
            <div className="search-page w-full flex flex-col justify-center items-center z-[999]">
                <section className="mt-5">
                    <div className="pt-10">
                        <h1 className="text-white lg:text-5xl text-center text-3xl font-bold mb-2" style={{ fontFamily: 'Poppins', textShadow: '2px 2px 3px #000000', letterSpacing: '2px' }}>Welcome to MovieApp</h1>
